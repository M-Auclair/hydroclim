...
filepath = "C:/Users/maucl/Documents/R_Scripts/Packages/hydroclim/data/"
input_file = "climate_data"
output_file = "climate_data_merged"
extension = ".rda"

# Function to update climate data

clim_data_update <- function(
    filepath,
    input_file,
    output_file
)
...
{
  data <- load(file = paste0(filepath, input_file, extension))
  ...
  if(max(data$date) < Sys.Date() - 1) {
    ...
    print("Climate dataset is already up-to-date!")
